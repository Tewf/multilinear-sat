...
| `tilted-sampling-loop/` | gradient and sampling as one tilted-objective loop: natural evolution strategies, cross-entropy, control variates, annealed and population sampling, sample-guided decimation, and whether GPU parallelism compensates slow mixing | gaussian-surrogate | done 2026-08-29 |
